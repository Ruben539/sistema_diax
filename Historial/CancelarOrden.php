...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-user-times"></i> Cancelación de Ordenes 
        </h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <form action="../Buscadores/BuscarOrden.php" method="POST">
                <div class="form-group">
                        <label class="control-label">Busqueda de la Orden</label>
                        <input class="form-control" type="text" name="cedula" id="cedula"  placeholder="Ingrese la Cedula del Paciente">
                    </div>
                </div>
