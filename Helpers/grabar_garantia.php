...
if (!empty($_POST)) {
	...
	if (empty($_POST['modelo']) || empty($_POST['nro_partida']) || empty($_POST['pieza']) || empty($_POST['observacion'])) {
		...
		$query = mysqli_query($conection,"SELECT * FROM reclamos WHERE nro_partida = '$nro_partida' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO reclamos(modelo,nro_partida,pieza,cantidad,destino,observacion,solicitante)
				VALUES('$modelo','$nro_partida','$pieza','$cantidad','$destino','$observacion','$solicitante')");
...
?>
 ...
 <main class="app-content">
      ...
      <div class="row" style="justify-content: center;">
        <div class="col-md-5">
          <div class="tile">
            <h3 class="tile-title">Registro de Garantia</h3>
            <div class="tile-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                  <label class="control-label">Observación sobre el Pedido</label>
                  <textarea class="form-control" rows="4" name="observacion" id="observacion"  placeholder="Ingrese la Observacion" required></textarea>
                </div>
                 
                 <input type="hidden" name="solicitante" id="solicitante" value="<?php echo $_SESSION['user'];?>">
                 <div class="tile-footer">
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/garantia.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
