...
if (!empty($_POST)) {
	...
	if (empty($_POST['modelo']) || empty($_POST['nro_vehiculo']) || empty($_POST['color']) || empty($_POST['falla_detectada'])) {
		...
		$query = mysqli_query($conection,"SELECT * FROM deposito WHERE nro_vehiculo = '$nro_vehiculo' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO deposito(nro_vehiculo,modelo,pieza,color,falla_detectada,origen,usuario,estado,sector)
				VALUES('$nro_vehiculo','$modelo','$pieza','$color','$falla_detectada','$origen','$usuario','$estado','$sector')");
...
?>
 ...
 <main class="app-content">
      ...
      <div class="row" style="justify-content: center;">
        <div class="col-md-5">
          <div class="tile">
            <h3 class="tile-title">Registro de Taller</h3>
            <div class="tile-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="falla_detectada" id="falla_detectada"  placeholder="Ingrese la Falla Detectada" required></textarea>
                </div>
                <div class="form-group">
                  <label class="control-label">Origen</label>
                  <input class="form-control" type="text" name="origen" id="origen" placeholder="Ingrese el Origen" required>
                </div>
                 <input type="hidden" name="sector" id="sector" value="<?php echo "LEVANTE" ?>">
              ...
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/deposito.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
