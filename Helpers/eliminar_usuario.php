...
$query_delete = mysqli_query($conection,"UPDATE usuario SET estatus = 0 WHERE id_usuario = $id_usuario AND estatus = 1 ");
//mysqli_close($conection);//con esto cerramos la conexion a la base de datos una vez conectado arriba con el conexion.php

if ($query_delete) {
	header('location: ../Plantillas/usuario_trash.php');
}else{
...
<main class="app-content">
  <div class="container">
    <div class="jumbotron">
      ...
      <h1 class="text-center"> Eliminar usuario N° <?php echo $iduser;?></h1>
      ...
      <hr class="my-4">          
				...
				href="../Plantillas/usuarios.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div>   
  </div>
