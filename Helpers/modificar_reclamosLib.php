...
//exit; sirve para ejectuar la consulta en mysql
	...
	if ($resultado > 0) {
		...
		$sql_update = mysqli_query($conection,"UPDATE producto SET modelo = '$modelo',nro_caja = '$nro_caja',nro_partida = '$nro_partida', descripcion = '$descripcion',estado = '$estado',proveedor = '$proveedor',existencia = '$existencia', estatus = 0
			WHERE codproducto = $codproducto");
...
$sql = mysqli_query($conection,"SELECT * FROM producto WHERE codproducto = $codproducto AND estatus= 0");
...
?>
 <main class="app-content">
      ...
      <div class="row" style="justify-content: center;">
        <div class="col-md-5">
          <div class="tile">
            <h3 class="tile-title">Modficar Reclamo Cerrado</h3>
            <div class="tile-body">
              ...
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/reclamos_lib.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
