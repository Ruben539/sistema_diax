...
$query_delete = mysqli_query($conection,"UPDATE herreria SET usuario = '$usuario', fecha_fin = '$fecha_fin',estado = '$estado', estatus = 0 WHERE id_herreria = $id_herreria ");
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM herreria  WHERE id_herreria = $id_herreria AND estatus = 1");
    ...
    <div class="jumbotron">
      ...
      <hr class="my-4">          
			...
			<form method="POST" action="">
				<input type="hidden" name="id_herreria" value="<?php echo $id_herreria; ?>">
				...
				href="../Plantillas/herreria.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div>   
  </div>
</main>