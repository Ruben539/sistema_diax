...
if (!empty($_POST)) {
	...
	if (empty($_POST['modelo']) || empty($_POST['nro_vehiculo']) || empty($_POST['color']) || empty($_POST['falla_detectada'])) {
		...
		$query = mysqli_query($conection,"SELECT * FROM ruedas WHERE nro_vehiculo = '$nro_vehiculo' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO ruedas(nro_vehiculo,modelo,pieza,color,falla_detectada,usuario,estado,sector)
        ...
        <div class="col-md-5">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/ruedas.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
