...
if (!empty($_POST)) {
	...
	if (empty($_POST['modelo']) || empty($_POST['nro_vehiculo']) || empty($_POST['color']) || empty($_POST['falla_detectada'])) {
		...
		$query = mysqli_query($conection,"SELECT * FROM herreria WHERE nro_vehiculo = '$nro_vehiculo' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO herreria(nro_vehiculo,modelo,pieza,color,falla_detectada,usuario,estado,sector)
				VALUES('$nro_vehiculo','$modelo','$pieza','$color','$falla_detectada','$usuario','$estado','$sector')");
...
?>
 ...
 <main class="app-content">
      ...
      <div class="row" style="justify-content: center;">
        <div class="col-md-5">
          <div class="tile">
            <h3 class="tile-title">Registro de Herreria</h3>
            <div class="tile-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                 ...
                 <input type="hidden" name="sector" id="sector" value="<?php echo "HERRREIA" ?>">
              ...
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/herreria.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
