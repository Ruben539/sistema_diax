...
//exit; sirve para ejectuar la consulta en mysql
		$query = mysqli_query($conection,"SELECT * FROM probado
	...
	if ($resultado > 0) {
		...
		$sql_update = mysqli_query($conection,"UPDATE probado SET modelo = '$modelo',nro_vehiculo = '$nro_vehiculo', color = '$color',pieza = '$pieza',falla_detectada = '$falla_detectada', estatus = 1
			WHERE id_probado = $id_probado");
...
$sql = mysqli_query($conection,"SELECT * FROM probado WHERE id_probado = $id_probado AND estatus= 1");
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form action="" method="POST">
                  <input type="hidden" name="id" id="id" value="<?php echo $id_probado; ?>">
              ...
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/probado.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
