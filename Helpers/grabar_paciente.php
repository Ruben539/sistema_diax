...
if (!empty($_POST)) {
  ...
  if (empty($_POST['Cedula']) || empty($_POST['Nombre']) || empty($_POST['Apellido']) || empty($_POST['Sexo']) || empty($_POST['Celular']) || empty($_POST['Nacimiento'])) {
    ...
    if ($resultado > 0) {
      ...
      if ($query_insert) {
        header('Location: ../Plantillas/registro.php');
      } else {
        ...
        <div class="tile-body">
          <form action="" method="POST">
            ...
            <div class="tile-footer">
              ...
              </button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/registro_pacientes.php"><i class="fa fa-fw fa-lg fa-arrow-right"></i>Regresar</a>
