...
//exit; sirve para ejectuar la consulta en mysql
		$query = mysqli_query($conection,"SELECT * FROM deposito
	...
	if ($resultado > 0) {
		...
		$sql_update = mysqli_query($conection,"UPDATE deposito SET modelo = '$modelo',nro_vehiculo = '$nro_vehiculo', color = '$color',pieza = '$pieza',falla_detectada = '$falla_detectada',origen = '$origen', estatus = 1
			WHERE id_deposito = $id_deposito");
...
$sql = mysqli_query($conection,"SELECT * FROM deposito WHERE id_deposito = $id_deposito AND estatus= 1");
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form action="" method="POST">
                  <input type="hidden" name="id" id="id" value="<?php echo $id_deposito; ?>">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  value="<?php echo $origen; ?>">
                </div>                                  
                 <div class="tile-footer">
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/deposito.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
