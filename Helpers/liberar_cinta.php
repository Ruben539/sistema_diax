...
$query_delete = mysqli_query($conection,"UPDATE cinta SET usuario = '$usuario', fecha_fin = '$fecha_fin',estado = '$estado', estatus = 0 WHERE id_cinta = $id_cinta ");
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM cinta  WHERE id_cinta = $id_cinta AND estatus = 1");
...
<main class="app-content">
	...
	<form method="POST" action="">
      <h4 class="display-4 text-center" style="font-size: 36px;"><?php echo $modelo?></h4>
      ...
      <hr class="my-4">          
				...
				<input type="hidden" name="id_cinta" value="<?php echo $id_cinta; ?>">
				...
				href="../Plantillas/cinta.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div>   
  </div>
</main>