...
$query_delete = mysqli_query($conection,"UPDATE producto SET  fecha_fin = '$fecha_fin', estatus = 0 WHERE codproducto = $codproducto ");
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM producto  WHERE codproducto = $codproducto AND estatus = 1");
...
<main class="app-content">
    ...
    <div class="container">
    <div class="jumbotron">
	  <h2 class="text-center">Liberar Reclamo N° <?php echo $codproducto; ?> ?</h2>
	  <hr class="my-4">
      ...
      <hr class="my-4">          
			...
			<form method="POST" action="">
				...
				href="../Plantillas/reclamos.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div>   
  </div>
</main>