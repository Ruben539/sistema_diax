...
$query_delete = mysqli_query($conection,"UPDATE pintura SET usuario = '$usuario', fecha_fin = '$fecha_fin',estado = '$estado', estatus = 0 WHERE id_pintura = $id_pintura ");
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM pintura  WHERE id_pintura = $id_pintura AND estatus = 1");
    ...
    <div class="jumbotron">
      ...
      <hr class="my-4">          
			...
			<form method="POST" action="">
				<input type="hidden" name="id_pintura" value="<?php echo $id_pintura; ?>">
				...
				href="../Plantillas/pintura.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div>   
  </div>
</main>