...
$query_delete = mysqli_query($conection,"UPDATE ruedas SET usuario = '$usuario', fecha_fin = '$fecha_fin',estado = '$estado', estatus = 0 WHERE id_ruedas = $id_ruedas ");
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM ruedas  WHERE id_ruedas = $id_ruedas AND estatus = 1");
    ...
    <div class="jumbotron">
      ...
      <hr class="my-4">          
			...
			<form method="POST" action="">
				<input type="hidden" name="id_ruedas" value="<?php echo $id_ruedas; ?>">
				...
				href="../Plantillas/ruedas.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div>   
  </div>
</main>