...
$query_delete = mysqli_query($conection,"UPDATE medicos SET estatus = 0 WHERE id = $id ");
//mysqli_close($conection);//con esto cerramos la conexion a la base de datos una vez conectado arriba con el conexion.php
...
if (empty($_REQUEST['id']) || $_REQUEST['id'] == 1) {
	...
	$query = mysqli_query($conection,"SELECT * FROM medicos WHERE id = $id");
	...
	if ( $resultado > 0) {
		...
		while ($data = mysqli_fetch_array($query)) {
			$Nombre        = $data['Nombre'];
			$Especialidad  = $data['Es$Especialidad'];
...
<main class="app-content">
  <div class="container">
    <div class="jumbotron">
      ...
      <h2 class="text-center">Especialidad: <span class="form-group"><?php echo $Especialidad;?></span></h2>    
