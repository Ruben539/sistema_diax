...
//exit; sirve para ejectuar la consulta en mysql
		$query = mysqli_query($conection,"SELECT * FROM herreria
	...
	if ($resultado > 0) {
		...
		$sql_update = mysqli_query($conection,"UPDATE herreria SET modelo = '$modelo',nro_vehiculo = '$nro_vehiculo', color = '$color',pieza = '$pieza',falla_detectada = '$falla_detectada', estatus = 1
			WHERE id_herreria = $id_herreria");
...
$id_herreria = $_REQUEST['id'];

$sql = mysqli_query($conection,"SELECT * FROM herreria WHERE id_herreria = $id_herreria AND estatus= 1");
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form action="" method="POST">
                  <input type="hidden" name="id" id="id" value="<?php echo $id_herreria; ?>">
              ...
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Plantillas/herreria.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
