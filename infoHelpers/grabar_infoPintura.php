...
if (!empty($_POST)) {
	...
	if (empty($_POST['modelo']) || empty($_POST['nro_partida'])) {
		...
		$query = mysqli_query($conection,"SELECT * FROM infopintura WHERE nro_partida = '$nro_partida' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO infoPintura(nro_partida,modelo,meta_varilla,meta_sosten,meta_horquilla,
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Meta Diaria de Pintura</h5>
      </div>
