...
if (!empty($_POST)) {
	...
	if (empty($_POST['modelo']) || empty($_POST['nro_partida']) || empty($_POST['sector']) || empty($_POST['falla_detectada'])) {
		...
		$query = mysqli_query($conection,"SELECT * FROM verificacion_produccion WHERE nro_partida = '$nro_partida' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO verificacion_produccion(nro_partida,modelo,pieza,sector,falla_detectada,solucion,cantidad,usuario)
				VALUES('$nro_partida','$modelo','$pieza','$sector','$falla_detectada','$solucion','$cantidad','$usuario')");
            ...
            <div class="tile-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="sector" id="sector" placeholder="Ingrese el Responsable" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="falla_detectada" id="falla_detectada"  placeholder="Ingrese la Falla" style="height: 45px;" ></textarea>
                </div>
                <div class="form-group">
                  <label class="control-label">Solucion</label>
                  <textarea class="form-control" rows="4" name="solucion" id="solucion"  placeholder="Ingrese la Solucion" style="height: 45px;" ></textarea>
                </div>
...
<script>
    function restar(){
        try{ 
        var numero1 = parseInt(document.getElementById('pieza').value);
        var numero2 = parseInt(document.getElementById('sector').value);
        var resultado;
