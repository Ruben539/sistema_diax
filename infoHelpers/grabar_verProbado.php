...
if (!empty($_POST)) {
	...
	if ( empty($_POST['modelo']) || empty($_POST['nro_partida']) || empty($_POST['falla_detectada']) || empty($_POST['cantidad'])) {
    ...
    $usuario          = $_POST['usuario'];
		...
		$query = mysqli_query($conection,"SELECT * FROM verificacion_probado WHERE nro_partida = '$nro_partida' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO verificacion_probado(nro_partida,modelo,falla_detectada,cantidad,observacion,usuario)
				VALUES('$nro_partida','$modelo','$falla_detectada','$cantidad','$observacion',' $usuario')");
...
?>
 ...
 <main class="app-content">
      ...
      <div class="row" style="justify-content: center;">
        <div class="col-md-5">
          <div class="tile">
            <h3 class="tile-title">Registro de Verificación Probado</h3>
            <div class="tile-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="observacion" id="observacion"  placeholder="Ingrese la Falla Detectada" required></textarea>
                </div>
                
                 <input type="hidden" name="usuario" id="usuario" value="<?php echo $_SESSION['user'];?>">
                 <div class="tile-footer">
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Informes/verificador_Probado.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
