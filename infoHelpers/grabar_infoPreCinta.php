...
if (!empty($_POST)) {
    ...
    $total_producido= $_POST['total_producido'];
		...
		$query = mysqli_query($conection,"SELECT * FROM precinta WHERE nro_partida = '$nro_partida' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"INSERT INTO precinta(nro_partida,modelo,total_producido,meta_diaria,observacion,usuario,diferencia)
				VALUES('$nro_partida','$modelo','$total_producido','$meta_diaria','$observacion','$usuario','$diferencia')");
            ...
            <div class="tile-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" name="total_producido" id="total_producido" placeholder="Ingrese la total_producido"
                  oninput="restar()" required>
                </div>
                <div class="form-group">
                  <label class="control-label">Diferencia</label>
                  <input class="form-control" type="number" name="diferencia" id="diferencia" placeholder="Ingrese la total_producido" value="alert(resultado)" required>
                </div>
                <div class="form-group">
