...
if (!empty($_POST)) {
	...
	if (empty($_POST['usuario']) ) {
		...
		$query = mysqli_query($conection,"SELECT * FROM verificacion_pintura WHERE total_varilla = '$total_varilla' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"UPDATE verificacion_pintura SET total_varilla = '$total_varilla',total_sosten = '$total_sosten',total_horquilla = '$total_horquilla',
            ...
            WHERE id_verPintura = '$id_verPintura' ");
...
$id_verPintura = $_REQUEST['id'];

$sql = mysqli_query($conection,"SELECT * FROM verificacion_pintura WHERE id_verPintura = $id_verPintura AND estatus= 1");
...
if ($resultado == 0) {
	header("location:../Informes/verificador_Pintura.php");
}else{
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Total Verificado de Pintura</h5>
      </div>
      <div class="modal-body">
 
		<form action="" method="POST">
       <div  class="formulario" id="formulario">
           <input type="hidden" name="id" id="id" value="<?php echo $id_verPintura;?>">      
		...
		<div class="tile-footer" >
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="../Informes/verificador_Pintura.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
          </div>
		</form>
      <br>
               <?php if(isset($alert)) {?>
