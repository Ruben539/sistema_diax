...
if (!empty($_POST)) {
	...
	if (empty($_POST['usuario']) ) {
		...
		$query = mysqli_query($conection,"SELECT * FROM infoherreria WHERE total_varilla = '$total_varilla' ");

		$resultado = mysqli_fetch_array($query);



			$query_insert = mysqli_query($conection,"UPDATE infoherreria SET total_varilla = '$total_varilla',total_sosten = '$total_sosten',total_horquilla = '$total_horquilla',
            ...
            WHERE id_infoHerreria = '$id_infoHerreria' ");
...
$id_infoHerreria = $_REQUEST['id'];

$sql = mysqli_query($conection,"SELECT * FROM infoherreria WHERE id_infoHerreria = $id_infoHerreria AND estatus= 1");
...
if ($resultado == 0) {
	header("location:../Informes/informeHerreria.php");
}else{
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Total Producido</h5>
      </div>
      <div class="modal-body">
 
		<form action="" method="POST">
       <div  class="formulario" id="formulario">
           <input type="hidden" name="id" id="id" value="<?php echo $id_infoHerreria;?>">      
