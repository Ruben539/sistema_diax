...
if ($query_delete) {
	header('location: ../Plantillas/orden_Deposito.php');
}else{
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM orden_trabajo  WHERE id_orden = $id_orden AND estatus = 8");
...
<main class="app-content">
    ...
    <div class="jumbotron">
	  <h1 class="text-center">Desea Liberar la OT <?php echo $id_orden?> ?</h1>
	  <hr class="my-4"> 
      ...
      <hr class="my-4">          
			<form method="POST" action="">
				...
				href="../Plantillas/orden_Pintura.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div> 
