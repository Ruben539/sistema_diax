...
if ($query_delete) {
	header('location: ../Plantillas/orden_Pintura.php');
}else{
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM orden_trabajo  WHERE id_orden = $id_orden AND estatus = 4");
