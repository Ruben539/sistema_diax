...
if ($query_delete) {
	header('location: ../Plantillas/orden_Herreria.php');
}else{
...
if (!empty($_REQUEST['id'])) {
	...
	$query = mysqli_query($conection,"SELECT * FROM orden_trabajo  WHERE id_orden = $id_orden AND estatus = 3");
    ...
    <div class="jumbotron">
      ...
      <hr class="my-4">          
			...
			<form method="POST" action="">
				...
				href="../Plantillas/orden_Herreria.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>No,Cancelar</a>
			</form>
   </div> 
  </div>
</main>