...
if(!empty($_POST))
{
      ...
      FROM historial h  inner join clientes c on c.cedula = h.cedula WHERE Atendedor LIKE '%".$medico."%' AND h.Cedula LIKE LOWER('%".$aKeyword[0]."%') OR c.Nombre LIKE LOWER('%".$aKeyword[0]."%') ";
