<?php 
$planillas = "Pintura Pendientes.xls";
 ...
 <table id="tabla_Pintura" class="table table-striped table-bordered table-condensed" style="width:100%">
                  ...
                  <tbody>
                      ...
                      require_once("../Modelos/conexion.php");
                        $sql = mysqli_query($conection,"SELECT id_pintura,fecha_add,modelo,nro_vehiculo,color,pieza,falla_detectada,sector,estado,usuario
