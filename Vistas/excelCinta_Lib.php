     ...
     <table id="tabla_Cinta" class="table table-striped table-bordered table-condensed" style="width:100%">
                  ...
                  <tbody>
					  ...
					  require_once("../Modelos/conexion.php");
                        $sql = mysqli_query($conection,"SELECT id_cinta,fecha_add,modelo,nro_vehiculo,color,pieza,falla_detectada,sector,estado,usuario,fecha_fin
