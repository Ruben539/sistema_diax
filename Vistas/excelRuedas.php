<?php 
$planillas = "Ruedas Pendientes.xls";
...
<table id="tabla_Ruedas" class="table table-striped table-bordered table-condensed" style="width:100%">
                  ...
                  <tbody>
					  ...
					  require_once("../Modelos/conexion.php");
                        $sql = mysqli_query($conection,"SELECT id_ruedas,fecha_add,modelo,nro_vehiculo,color,pieza,falla_detectada,sector,estado,usuario
