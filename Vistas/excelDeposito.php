<?php 
$planillas = "Taller Pendientes.xls";
 ...
 <table id="tabla_Deposito" class="table table-striped table-bordered table-condensed" style="width:100%">
                  ...
                  <tbody>
					  ...
					  require_once("../Modelos/conexion.php");
                        $sql = mysqli_query($conection,"SELECT id_deposito,fecha_add,modelo,nro_vehiculo,color,pieza,falla_detectada,usuario,origen,sector,estado
