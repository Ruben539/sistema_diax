...
<main class="app-content">
      <div class="app-title">
        <div>
          ...
          <h1><i class="fa fa-th-list"></i> Informe Diario - Verificación Pintura  <a href="../infoHelpers/grabar_verPintura.php"> 
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li class="breadcrumb-item active"><a href="../VistasInfo/excelInfo_pintura.php">Excel</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
              <div class="table-responsive">
                 <table id="tabla_Pintura" class="table table-striped table-bordered table-condensed" style="width:100%">
                  ...
                  <tbody>
                      <?php 
                        $sql = mysqli_query($conection,"SELECT id_verPintura,fecha_add,nro_partida,modelo,diferencia_varilla,diferencia_sosten,diferencia_horquilla,
		                  	...
		                  	diferencia_velocimetro,diferencia_adorno,diferencia_bulto,diferencia_chasis,diferencia_freno,diferencia_tanque,observacion,usuario from verificacion_pintura where estatus = 1");
  ...
  <?php if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 11) {?>
    <td>
		<a href="../infoHelpers/modificar_verPintura.php?id=<?php echo $data['id_verPintura']; ?>"class="btn btn-outline-info" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-edit"></i></a>
    </td>
    <?php } ?>
