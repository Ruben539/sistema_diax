...
<main class="app-content">
      <div class="app-title">
        <div>
          ...
          <h1><i class="fa fa-th-list"></i> Cumplimiento Diario - Pintura  <a href="../infoHelpers/grabar_infoPintura.php"> 
          ...
          <div class="tile">
              <div class="table-responsive">
                 <table id="tabla_Pintura" class="table table-striped table-bordered table-condensed" style="width:100%">
                  ...
                  <tbody>
                      <?php 
                        $sql = mysqli_query($conection,"SELECT id_infoPintura,fecha_add,nro_partida,modelo,diferencia_varilla,diferencia_sosten,diferencia_horquilla,
		                  	...
		                  	diferencia_velocimetro,diferencia_adorno,diferencia_bulto,diferencia_chasis,diferencia_freno,diferencia_tanque,observacion,usuario from infopintura where estatus = 1");
  ...
  <?php if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 4) {?>
    <td>
		<a href="../infoHelpers/grabar_totalPintura.php?id=<?php echo $data['id_infoPintura']; ?>"class="btn btn-outline-info" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-edit"></i></a>
    </td>
    <?php } ?>
