...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>Informe Diario - Ruedas <a href="../infoHelpers/grabar_infoRuedas.php"> 
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li class="breadcrumb-item active"><a href="../VistasInfo/excelInfo_Ruedas.php">Excel</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
	...
	<?php if ($_SESSION['rol'] == 1  || $_SESSION['rol'] == 5) {?>
        <td>
		<a href="../infoHelpers/modificar_infoRuedas.php?id=<?php echo $data['id_infoRuedas']; ?>"class="btn btn-outline-info" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-edit"></i></a>
	  </td>
        <?php } ?>
