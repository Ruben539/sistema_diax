...
<main class="app-content">
  ...
  <form class="row" method="POST" id='formCajaChica' name='formCajaChica'>
    <div class="col-md-5">
    ...
    <div class="col-md-2">
      ...
      <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-search"></i>Buscar
...
<script type="text/javascript">
  $('#formCajaChica').submit(function(e) {
    e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: '../Buscadores/BuscarCierre.php',
      data: form.serialize(),
