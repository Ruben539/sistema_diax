...
<main class="app-content">
      <div class="app-title">
        <div>
          ...
          <h1><i class="fa fa-th-list"></i> Orden de Trabajo - Garantia/otros <a href="../OT/grabar_otSupervision.php"> 
                  ...
                  <tbody>
                      <?php 
                        ...
                        $sql = mysqli_query($conection,"SELECT id_orden,fecha_add,modelo,nro_partida,pieza,color,cantidad,observacion,usuario_1,sector_1
                         from orden_trabajo where estatus = 8 ");
     ...
     <td>
		<a href="../OT/liberar_otDeposito.php?id=<?php echo $data['id_orden']; ?>"class="btn btn-outline-success" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-check"></i></a>
    </td>
