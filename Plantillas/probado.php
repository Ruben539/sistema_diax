...
<main class="app-content">
      <div class="app-title">
        ...
        <?php if($_SESSION['rol'] == 1 || $_SESSION['rol'] == 7){?>
          <h1><i class="fa fa-th-list"></i> Motos Pendientes - IyC <a href="../Helpers/grabar_probado.php"> 
        <button id="btnNew"  class="btn btn-primary" type="button"><i class="fa fa-plus-circle" aria-hidden="true"></i>
         Nuevo</button></a>
          </h1>
        <?php }?>
        <?php if($_SESSION['rol'] == 2){?>
          <h1><i class="fa fa-th-list"></i> Motos Pendientes - IyC 
        ...
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><a href="../Reportes/reporte_probado.php"><i class="fa fa-book fa-lg"></i> Reporte</a></li>
          <li class="breadcrumb-item active"><a href="../Vistas/excelProbado.php">Excel</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
	...
	<?php if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 7) {?>
    <td>
		<a href="../Helpers/modificar_probado.php?id=<?php echo $data['id_probado']; ?>"class="btn btn-outline-info" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-edit"></i></a>
  </td>
    <?php } ?>
                           
	<?php if($_SESSION['rol'] == 1 || $_SESSION['rol'] == 7){ ?>
    <td>
		<a href="../Helpers/liberar_probado.php?id=<?php echo $data['id_probado']; ?>"class="btn btn-outline-success" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-check"></i></a>
    </td>
	<?php } ?>
                            </td>
                        </tr>
